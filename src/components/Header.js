            ...
            <div className="container py-4">
                <div className="container-nav row d-flex py-5 justify-content-center">
                    <div className="col col-lg-2 text-start nav-start order-1 order-lg-1">
                        <NavLink to="/" className="nav-start-1 text-base text-black mt-2 pt-1">
                            Elmer Epogon
                    ...
                    <div className="col-lg-8 text-center nav-main order-3 order-lg-2">
                        <NavLink to="/about" className={`text-base text-600 mx-3 font-normal ${activePath === '/about' ? 'active' : ''}`}>
                            About{activePath === '/about' && <i className="bi bi-arrow-down m-0 p-0"></i>}
                        </NavLink>

                        <NavLink to="/project" className={`text-base text-600 mx-3 font-normal ${activePath === '/project' ? 'active' : ''}`}>
                            Project{activePath === '/project' && <i className="bi bi-arrow-down m-0 p-0"></i>}
                        </NavLink>

                        <NavLink to="/experience" className={`text-base text-600 mx-3 font-normal ${activePath === '/experience' ? 'active' : ''}`}>
                            Experience{activePath === '/experience' && <i className="bi bi-arrow-down m-0 p-0"></i>}
                        </NavLink>

                        <NavLink to="/contact" className={`text-base text-600 mx-3 font-normal ${activePath === '/contact' ? 'active' : ''}`}>
